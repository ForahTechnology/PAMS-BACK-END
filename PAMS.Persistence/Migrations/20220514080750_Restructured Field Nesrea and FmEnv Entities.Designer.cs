...
namespace PAMS.Persistence.Migrations
{
    ...
    [Migration("20220514080750_Restructured Field Nesrea and FmEnv Entities")]
    partial class RestructuredFieldNesreaandFmEnvEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PAMS.Domain.Entities.FieldScientistEntities.DPRFieldResult", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("DPRFieldResult");
                });

            modelBuilder.Entity("PAMS.Domain.Entities.FieldScientistEntities.DPRTemplate", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PAMS.Domain.Entities.FieldScientistEntities.FMENVFieldResult", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("FMENVFieldResult");
                });

            modelBuilder.Entity("PAMS.Domain.Entities.FieldScientistEntities.FMENVTemplate", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PAMS.Domain.Entities.FieldScientistEntities.NESREAFieldResult", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("NESREAFieldResult");
                });

            modelBuilder.Entity("PAMS.Domain.Entities.FieldScientistEntities.NESREATemplate", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PAMS.Domain.Entities.Sampling", b =>
                {
                    ...
                    b.Property<bool>("IsReportCreated")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PAMS.Domain.Entities.FieldScientistEntities.FMENVFieldResult", b =>
                {
                    b.HasOne("PAMS.Domain.Entities.FieldScientistEntities.FMENVField", "FMENVField")
                        .WithMany("FMENVSamples")
                        .HasForeignKey("FMENVFieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PAMS.Domain.Entities.FieldScientistEntities.NESREAFieldResult", b =>
                {
                    b.HasOne("PAMS.Domain.Entities.FieldScientistEntities.NESREAField", "NESREAField")
                        .WithMany("NESREASamples")
                        .HasForeignKey("NESREAFieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
